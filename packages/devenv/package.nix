...
rustPlatform.buildRustPackage {
  ...
  src = fetchFromGitHub {
    owner = "cachix";
    repo = "devenv";
    rev = "84ddd3a24ecc2d25acc25e5f36acfe89f351598c";
    hash = "sha256-lYTGAqwfzHGX/iRW2n1fM3eLjGSpcsatWOuGaLpH470=";
  };

  cargoHash = "sha256-QQDGEOC2H/i7r3gXKDPl8tvnO6aHwY26KXjZl3uTag4=";
